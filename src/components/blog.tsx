        ...
        <main className="blog-container">
             <div className="blog-container2">
              ...
              <div className="blog-box">
                ...
                <Link className="watch-btn" href={"https://youtu.be/baLdGxd9FBA?si=2PhNk_Om7NidHNO0"}>Watch Now <HiMiniArrowTopRightOnSquare className="arrow"/></Link>              </div>
              <div className="blog-box">
                ...
                <Link className="watch-btn" href={"/"}>Watch Now <HiMiniArrowTopRightOnSquare className="arrow"/></Link>              </div>
              <div className="blog-box">
                ...
                <Link className="watch-btn" href={"/"}>Watch Now <HiMiniArrowTopRightOnSquare className="arrow"/></Link>
              </div>
