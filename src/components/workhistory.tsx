             ...
             <div className="education-container2">
              ...
              <div className="education-box">
                ...
                <div className="right-box">
                    ...
                    <p className="uni-des ">In 2024, I enrolled in the University of Karachi to pursue a Bachelor&apos;s in Computer Science, combining academic knowledge with practical skills.</p>
                </div>
              </div>
              <div className="education-box">
                {/* left */}
