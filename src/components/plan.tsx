        ...
        <main className="plan-container">
             <div className="plan-container2">
              ...
              <div className="plan-header-box">
                <h1 className="plan-title">Price plans</h1>
                <p className="plan-des">Choose a plan that fits your needs and budget. From simple websites to advanced solutions, every package ensures quality and reliable support.</p>
              </div>
              {/* boxes div */}
